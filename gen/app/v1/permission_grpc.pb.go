...
const (
	PermissionService_Create_FullMethodName = "/app.v1.PermissionService/Create"
	PermissionService_Get_FullMethodName    = "/app.v1.PermissionService/Get"
	PermissionService_List_FullMethodName   = "/app.v1.PermissionService/List"
	PermissionService_Update_FullMethodName = "/app.v1.PermissionService/Update"
	PermissionService_Delete_FullMethodName = "/app.v1.PermissionService/Delete"
)
...
func (c *permissionServiceClient) Create(ctx context.Context, in *CreatePermissionReq, opts ...grpc.CallOption) (*Permission, error) {
...
func (c *permissionServiceClient) Get(ctx context.Context, in *GetPermissionReq, opts ...grpc.CallOption) (*Permission, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Permission)
...
func (c *permissionServiceClient) List(ctx context.Context, in *ListPermissionReq, opts ...grpc.CallOption) (*ListPermissionResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *permissionServiceClient) Update(ctx context.Context, in *UpdatePermissionReq, opts ...grpc.CallOption) (*Permission, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Permission)
...
func (UnimplementedPermissionServiceServer) Create(context.Context, *CreatePermissionReq) (*Permission, error) {
	return nil, status.Error(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedPermissionServiceServer) Get(context.Context, *GetPermissionReq) (*Permission, error) {
	return nil, status.Error(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedPermissionServiceServer) List(context.Context, *ListPermissionReq) (*ListPermissionResp, error) {
...
func _PermissionService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).Create(ctx, req.(*CreatePermissionReq))
	}
...
func _PermissionService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).Get(ctx, req.(*GetPermissionReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PermissionService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).List(ctx, req.(*ListPermissionReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PermissionService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).Update(ctx, req.(*UpdatePermissionReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PermissionService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionServiceServer).Delete(ctx, req.(*DeletePermissionReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PermissionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "app.v1.PermissionService",
	...
	Metadata: "app/v1/permission.proto",
}
